...
# -- identity lines ------------------------------------------------------------
SERVICE_NAME="seren-observatory$INSTANCE"
MODULE="seren_observatory"
[[ -n "$VENV_DIR" ]] || VENV_DIR="$HOME/seren-venvs/observatory$INSTANCE"
[[ -n "$APP_DIR"  ]] || APP_DIR="$HOME/seren-observatory$INSTANCE"
[[ -n "$CFG_PATH" ]] || CFG_PATH="$APP_DIR/seren-observatory.yaml"
