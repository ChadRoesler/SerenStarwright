#!/bin/bash
# ══════════════════════════════════════════════════════════════
# xavier/msmoe.sh — Install Ms.MoE Maker (xavier)
#
...
#
# Xavier: JetPack 5.1.x, cp310 (altinstall), arch 72. eMMC is ~32GB, so both the venv and the run root belong on NVMe.
#
