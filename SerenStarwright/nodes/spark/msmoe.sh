...
#
# Spark: Blackwell GB10, 128GB unified memory, JP7-native CUDA. No SerenSystemPrebuilts wheels exist for it and none are needed - the redist path is the live one here, which is why the staged-wheel branch is a courtesy rather than the plan.
#
